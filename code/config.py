...
BASE_DATA_PATH = Path("D:/TrafficCaptioning/trafficcaptioning")
CSV_FEATURE_PATH = BASE_DATA_PATH / "csv"
VIDEO_DESCRIPTIONS_PATH = BASE_DATA_PATH / "video_descriptions.pkl"
BERT_MODEL_PATH = "D:/TrafficCaptioning/bert-base-uncased"
